...
public abstract class CommentsManager implements DataModelCommand {
	...
	private DotNotationCommandManager commMan = new DotNotationCommandManager(getSimpleName(), new CommentsCount());
	
	public CommentsManager() {
		commMan.add("comment", new TrataComment(Fields.comment));
		commMan.add("location", new TrataComment(Fields.location));
		commMan.add("timestamp", new TrataComment(Fields.timestamp));
	}
	...
	private class TrataComment implements DotNotationCommand {
